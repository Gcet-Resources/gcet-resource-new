...
- Name: runtime-check.spec.ts >> runtime check: /coding-resources
- Location: tests/runtime-check.spec.ts:29:3

# Error details

```
Error: main content on /coding-resources
      ...
      - generic [ref=e7]:
        ...
        - generic [ref=e10]:
          ...
          - link "Login" [ref=e26] [cursor=pointer]:
            - /url: /login
    - generic [ref=e27]:
      - heading "Coding Resources" [level=1] [ref=e28]
      - generic [ref=e29]:
        - generic [ref=e31] [cursor=pointer]:
          - img [ref=e32]
          - heading "DSA Materials" [level=2] [ref=e35]
          - paragraph [ref=e36]: Learn Data Structures and Algorithms with our curated resources
        - generic [ref=e38] [cursor=pointer]:
          - img [ref=e39]
          - heading "Projects" [level=2] [ref=e44]
