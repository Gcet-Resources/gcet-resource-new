...
- Name: runtime-check.spec.ts >> runtime check: /coding-resources/dsa
- Location: tests/runtime-check.spec.ts:29:3

# Error details

```
Error: main content on /coding-resources/dsa
      ...
      - generic [ref=e7]:
        ...
        - generic [ref=e10]:
          ...
          - link "Login" [ref=e26] [cursor=pointer]:
            - /url: /login
    - generic [ref=e27]:
      - heading "DSA Resources" [level=1] [ref=e28]
      - generic [ref=e29]:
        - generic [ref=e31]:
          - generic [ref=e32]:
            - img [ref=e33]
            - generic [ref=e36]: Medium
          - heading "Striver Sheet" [level=3] [ref=e37]
          - paragraph [ref=e38]: A-Z DSA Sheet
          - link "Go to resource" [ref=e39] [cursor=pointer]:
        ...
        - generic [ref=e45]:
          ...
          - heading "DSA in C++" [level=3] [ref=e51]
          - paragraph [ref=e52]: Complete DSA YouTube playlist for C++ programmers
          - link "Go to resource" [ref=e53] [cursor=pointer]:
