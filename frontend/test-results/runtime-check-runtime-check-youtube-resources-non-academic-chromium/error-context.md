...
- Name: runtime-check.spec.ts >> runtime check: /youtube-resources/non-academic
- Location: tests/runtime-check.spec.ts:29:3

# Error details

```
Error: main content on /youtube-resources/non-academic
      ...
      - generic [ref=e7]:
        ...
        - generic [ref=e10]:
          ...
          - link "Login" [ref=e26] [cursor=pointer]:
            - /url: /login
    - generic [ref=e27]:
      - heading "Non-Academic Video Resources" [level=1] [ref=e28]
      - generic [ref=e29]:
        - link "Campus Life Vlog A day in the life of GCET students" [ref=e30] [cursor=pointer]:
          - /url: https://youtube.com/watch?v=sample3
          - generic [ref=e31]:
            - img [ref=e34]
            - generic [ref=e37]:
              - heading "Campus Life Vlog" [level=3] [ref=e38]
              - paragraph [ref=e39]: A day in the life of GCET students
        - link "Student Success Stories Inspiring stories from our alumni" [ref=e40] [cursor=pointer]:
          - /url: https://youtube.com/watch?v=sample4
          - generic [ref=e41]:
            - img [ref=e44]
            - generic [ref=e47]:
              - heading "Student Success Stories" [level=3] [ref=e48]
              - paragraph [ref=e49]: Inspiring stories from our alumni
```
