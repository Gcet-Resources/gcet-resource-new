  ...
  const SocialLink = ({
    ...
    return (
      <a
        ...
        aria-label={label}
        className="p-2 bg-gray-50 dark:bg-gray-700 rounded-full text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-teal-400 hover:bg-primary/10 dark:hover:bg-teal-500/20 transition-colors"
      >
