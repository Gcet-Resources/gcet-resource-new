...
import { MessageCircle, Mail, Heart, Shield } from "lucide-react";
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="max-w-md">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
              ...
              Helping GCET students excel in their academic journey.
            </p>
          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
                GCET Resources is a community-driven educational platform
                created by students, for students.
                <strong className="text-gray-700 dark:text-gray-300">
                  {" "}
                  We do not own or claim ownership of any educational content
                  displayed on this website.
                </strong>{" "}
                All study materials, notes, previous year questions, and other
                resources are sourced from various publicly available platforms,
                educators, and contributors. The original content creators and
                copyright holders retain all rights to their respective
                materials.
              </p>
              <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed mt-2">
                This platform operates under the principles of{" "}
                <strong className="text-gray-700 dark:text-gray-300">
                  fair use for educational purposes
                </strong>
                . We respect intellectual property rights and are committed to
                removing any content upon valid request from rightful owners. If
                you believe any content infringes your copyright, please contact
                us at{" "}
                <a
                  href="mailto:gcetresources@gmail.com"
                ...
                with relevant details, and we will promptly address your
                concerns.
              </p>
            </div>
          </div>
      ...
      <div className="border-t border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 py-4">
          <p className="text-center text-sm text-gray-500 dark:text-gray-400 flex items-center justify-center gap-1">
            © {currentYear} GCET Resources. Made with{" "}
            <Heart className="w-4 h-4 text-red-500 fill-red-500" /> for GCET
            students.
          </p>
        </div>
      </div>
