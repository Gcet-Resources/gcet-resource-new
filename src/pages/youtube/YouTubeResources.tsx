        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Academic Resources</h2>
              <p className="text-gray-600 dark:text-gray-400">
                Access course-related video content, lectures, and educational tutorials
              </p>
            </div>
          </Card>
          ...
          >
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Non-Academic Resources</h2>
              <p className="text-gray-600 dark:text-gray-400">
                Explore skill development, hobby-related, and entertainment content
              </p>
            </div>
          </Card>
        </div>
