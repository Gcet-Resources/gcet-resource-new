      ...
      <main className="container mx-auto px-4 pt-32 pb-20">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 animate-fade-in-up">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            GCET Resources is built by students, for students. Your support
            helps us cover server costs and keep this platform free for everyone
            forever.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-5 h-full min-h-[500px]">
              ...
              <div className="md:col-span-3 p-6 md:p-8">
                ...
                >
                  ...
                  <TabsContent
                    value="upi"
                    className="flex-1 flex flex-col items-center justify-center animate-in fade-in slide-in-from-bottom-2 duration-300"
                  >
                  ...
                  <TabsContent
                    value="coffee"
                    className="flex-1 flex flex-col justify-center animate-in fade-in slide-in-from-bottom-2 duration-300"
                  >
                    <div className="text-center space-y-6">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          Each coffee makes us code faster!
                        </p>
                      </div>
          ...
          <div className="mt-16 text-center space-y-6">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button
                variant="outline"
                className="gap-2 rounded-full h-11 px-6 hover:text-[#25D366] hover:border-[#25D366] hover:bg-[#25D366]/5 transition-colors"
              ...
              <Button
                variant="outline"
                className="gap-2 rounded-full h-11 px-6 hover:text-[#1DA1F2] hover:border-[#1DA1F2] hover:bg-[#1DA1F2]/5 transition-colors"
              ...
              <Button
                variant="outline"
                className="gap-2 rounded-full h-11 px-6 hover:text-[#0A66C2] hover:border-[#0A66C2] hover:bg-[#0A66C2]/5 transition-colors"
