      ...
      <main className="container mx-auto px-4 pt-32 pb-20">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 animate-fade-in-up">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Have a question, found a bug, or want to contribute? We're here to
            help!
          </p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="p-6 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 shadow-lg shadow-gray-100 dark:shadow-gray-900/50">
              ...
              <div className="space-y-3">
                ...
                <a
                  href="mailto:gcetresources@gmail.com?subject=Bug%20Report"
                  className="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-red-50 dark:hover:bg-red-900/10 group transition-colors"
                >
                  <div className="flex items-center gap-3">
                ...
                <button
                  onClick={copyEmail}
                  className="w-full flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 group transition-colors text-left"
                >
                  <div className="flex items-center gap-3">
